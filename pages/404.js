    ...
    <div className="min-h-[100vh] bg-main px-4 py-16 sm:px-6 sm:py-24 lg:px-8 overflow-y-hidden">
      <div className="mx-auto max-w-max">
        <main className="sm:flex">
          <p className="bg-gradient-to-br from-pink-400 to-cyan-600 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl text-center sm:text-left">
            404
          </p>
          <div className="sm:ml-6">
            <div className="sm:border-l sm:border-gray-200 sm:pl-6">
              <h1 className="text-4xl font-bold tracking-tight text-secondary sm:text-5xl text-center sm:text-left">
                Nie odnaleziono strony
              </h1>
              <p className="mt-6 text-base text-gray-500 text-center sm:text-left sm:mt-1">
